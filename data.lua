...
animations = {
	...
	jump = {
		frames = {
			...
			{ frame = 13, movement = {0, 0}},
			{ frame = 13, movement = {0, 0}},
			{ frame = 14, movement = {1.5, -3}},
			{ frame = 14, movement = {1.5, -3}},
			{ frame = 14, movement = {1.5, -3}},
			{ frame = 14, movement = {1.5, -2}},
			{ frame = 14, movement = {1.5, -2}},
			{ frame = 14, movement = {1.5, -2}},
			{ frame = 14, movement = {1.5, -1}},
			{ frame = 9, movement = {1.5, -1}},
			{ frame = 9, movement = {1.5, -1}},
			{ frame = 9, movement = {1.5, 0}},
			{ frame = 10, movement = {1.5, 0}},
			{ frame = 10, movement = {1.5, 0}},
			{ frame = 10, movement = {1.5, 1}},
			{ frame = 11, movement = {1.5, 1}},
			{ frame = 11, movement = {1.5, 1}},
			{ frame = 11, movement = {1.5, 2}},
			{ frame = 8, movement = {1.5, 2}},
			{ frame = 8, movement = {1.5, 2}},
			{ frame = 8, movement = {1.5, 3}},
			{ frame = 9, movement = {1.5, 3}},
			{ frame = 9, movement = {1.5, 3}},
		}
	},
	jump_punch = {
